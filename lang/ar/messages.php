...
return [
    ...
    'auth' => [
        ...
        'invalid_user_type' => 'نوع المستخدم غير موجود',
        'pass_user_type' => 'نوع المستخدم غير معروف',
    ...
    'quiz' => [
        ...
        'score_must_not_exceed' => ':score علامة الاختبار المؤتمت لا يجب ان تتعدى',
        'listed' => 'تم عرض الاختبارات المؤتمتة.',
        'fetched' => 'تم جلب الاختبار المؤتمت بنجاح.',
        'generated' => 'تم توليد الاختبار المؤتمت بنجاح.',
        'subject_grade_mismatch' => 'المادة غير موجودة بالصف.',
        'section_grade_mismatch' => 'الشعبة لا تنتمي للصف.'
    ],
    'question' => [
    ...
    'school_shift' => [
        ...
        'updated' => 'تم تعديل فترة الدوام المدرسي بنجاح.',
        'not_found' => 'لم يتم العثور على  فترة الدوام المدرسي.',
        'deleted' => 'تم حذف فترة الدوام المدرسي بنجاح.',
        'get' => 'تم عرض فترة الدوام المدرسي بنجاح.',
        'list' => 'تم عرض فترات الدوام المدرسي بنجاح.',
        'overlapped' => 'فترة الدوام المدرسي متداخلة مع فترة موجودة بالفعل.',
        'has_class_periods' => 'لا يمكن حذف فترة الدوام المدرسي، تحتوي على فترات دراسية.',
        'has_schedules' => 'لا يمكن حذف فترة الدوام المدرسي، تحتوي على جداول دراسية.',
        'deletion_failed' => 'فشل في حذف فترة الدوام المدرسي.'
    ],

    'timetable' => [
        'created' => 'تم إنشاء الجدول الزمني بنجاح.',
        'updated' => 'تم تعديل الجدول الزمني بنجاح.',
        'not_found' => 'لم يتم العثور على الجدول الزمني.',
        'deleted' => 'تم حذف الجدول الزمني بنجاح.',
        'get' => 'تم عرض الجدول الزمني بنجاح.',
        'list' => 'تم عرض الجداول الزمنية بنجاح.',
        'not_active' => 'الجدول الزمني غير مفعل.'
    ],

    'class_period' => [
        'created' => 'تم إنشاء الفترة الدراسية بنجاح.',
        'updated' => 'تم تعديل الفترة الدراسية بنجاح.',
        'deleted' => 'تم حذف الفترة الدراسية بنجاح.',
        'force_deleted' => 'تم حذف الفترة الدراسية وجميع السجلات المرتبطة بها بنجاح.',
        'not_found' => 'لم يتم العثور على الفترة الدراسية.',
        'get' => 'تم عرض الفترة الدراسية بنجاح.',
        'list' => 'تم عرض الفترات الدراسية بنجاح.',
        'has_class_sessions' => 'لا يمكن حذف الفترة الدراسية: لديها حصص دراسية مرتبطة. يرجى حذف الحصص الدراسية أولاً أو استخدام الحذف القسري.',
        'has_schedules' => 'لا يمكن حذف الفترة الدراسية: لديها جداول دراسية مرتبطة. يرجى حذف الجداول الدراسية أولاً أو استخدام الحذف القسري.',
        'cannot_delete' => 'لا يمكن حذف الفترة الدراسية بسبب العلاقات الموجودة.'
    ],

    'schedule' => [
        'created' => 'تم إنشاء الجدول الدراسي بنجاح.',
        'cant_be_created' => 'لا يمكن وضع الفرصة في الجدول الدراسي.',
        'updated' => 'تم تعديل الجدول الدراسي بنجاح.',
        'not_found' => 'لم يتم العثور على الجدول الدراسي.',
        'deleted' => 'تم حذف الجدول الدراسي بنجاح.',
        'get' => 'تم عرض الجدول الدراسي بنجاح.',
        'list' => 'تم عرض الجداول الدراسية بنجاح.'
    ],

    'class_session' => [
        'created' => 'تم توليد الحصص الدراسية لهذا الجدول لمدة 4 اسابيع.',
        'updated' => 'تم تعديل الحصة الدراسية بنجاح.',
        'not_found' => 'لم يتم العثور على الحصة الدراسية.',
        'deleted' => 'تم حذف الحصة الدراسية بنجاح.',
    ],

    'teacher_class_session' => [
        'past_week_success' => 'قائمة الحصص الدراسية للأسبوع الماضي',
        'upcoming_success' => 'قائمة الحصص الدراسية للأسبوعين القادمين',
        'no_sessions_found' => 'لا توجد حصص دراسية في الفترة المحددة',
        'unauthorized_access' => 'غير مصرح لك بالوصول لحصص هذه المادة والشعبة',
    ],

    'admin' => [
        'class_periods' => [
            'list_by_section' => 'قائمة الحصص الدراسية للشعبة',
            'no_periods_found' => 'لا توجد حصص دراسية للشعبة المحددة',
        ],
    ],
];
